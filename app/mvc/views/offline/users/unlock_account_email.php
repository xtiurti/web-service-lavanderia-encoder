                ...
                <form action="<?php echo url(); ?>" method="post">
                    ...
                    <div class="row">
                        ...
                        <p class="grey-text center-align info_painel">
                            Enviaremos para seu e-mail uma carta com as instruções para você <b class="black-text">Desbloquear</b> sua conta.
                            <br/>
                        ...
                        <button class="btn waves-effect waves-light btn-large orange tooltipped" data-position="bottom" data-delay="50" data-tooltip="Enviar instruções para meu e-mail." type="submit" name="action">
